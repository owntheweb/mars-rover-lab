...
RoverLab.prototype.onImageUpdate = function(imgLoc) {
	...
	//!!!test
	console.log(this.socketNamespace);
	console.log(self.socketNamespace);
...
RoverLab.prototype.startStreaming = function(io) {
	...
	//camera
	self.cam.start();
	self.cam.on('imageupdate', self.onImageUpdate.bind(self));
};
...
RoverLab.prototype.stopStreaming = function() {
	...
	self.cam.stop();
	self.sendingImage = false;
	self.cam.removeListener('imageupdate', onImageUpdate);
};
