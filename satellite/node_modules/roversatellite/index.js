			...
			if(data.roverPassword == self.roverPassword) {
				...
				*/
				...
				self.ss(socket).on('roverimage', function(stream, data) {
					...
					var tmpFilename = self.path.join(__dirname, ('web/PiCam/tmp-' + self.path.basename(data.name)));
					var finalFilename = self.path.join(__dirname, ('web/PiCam/' + self.path.basename(data.name)));
